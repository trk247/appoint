            ...
            <Container>
                <Content style={{backgroundColor: '#384850'}} theme={login} scrollEnabled={this.state.scroll}>
                    <Image source={require('../../../images/glow2.png')} style={styles.container}>
                        <Image source={require('../../../images/logo2.png')} style={styles.shadow}>
                            <View style={styles.bg}>
                                ...
                                <Button transparent onPress={() => this.pushNewRoute('forgotPassword')} style={{alignSelf: 'flex-end',  marginBottom: (Platform.OS === 'ios' ) ? 5 : 0, marginTop: (Platform.OS === 'ios' ) ? -10 : 0}}>
                                    <Text>
                                        Forgot Password
                                    </Text>
                                </Button>
