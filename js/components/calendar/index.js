...
class Calendar extends Component {
  ...
  onSubmit() {
    let {timeDate, date, uid, mon, tue, wed, thu, fri} = this.state;
...
<View style={styles.preferContainer}>      
          ...
          <ItemCheckbox // https://www.npmjs.com/package/react-native-item-checkbox
            ...
            size={20}
            label="Monday"
            onCheck={() => this.setState({mon: 'checked'})}
            onUncheck={() => this.setState({mon: ''})}
          ...
          <ItemCheckbox // https://www.npmjs.com/package/react-native-item-checkbox
            ...
            size={20}
            label="Tuesday"
            onCheck={() => this.setState({tue: 'checked'})}
            onUncheck={() => this.setState({tue: ''})}
            onChange={(checked) => this.setState({checked})}
          />
          ...
          <ItemCheckbox // https://www.npmjs.com/package/react-native-item-checkbox
            ...
            size={20}
            label="Wednesday"
            onCheck={() => this.setState({wed: 'checked'})}
            onUncheck={() => this.setState({wed: ''})}
            onChange={(checked) => this.setState({checked})}
          />
...
<ItemCheckbox // https://www.npmjs.com/package/react-native-item-checkbox
  ...
  size={20}
  label="Thursday"
  onCheck={() => this.setState({thu: 'checked'})}
  onUncheck={() => this.setState({thu: ''})}
  onChange={(checked) => this.setState({checked})}
/>
...
<ItemCheckbox // https://www.npmjs.com/package/react-native-item-checkbox
  ...
  size={20}
  label="Monday"
  onCheck={() => this.setState({fri: 'checked'})}
  onUncheck={() => this.setState({fri: ''})}
  onChange={(checked) => this.setState({checked})}
/>
